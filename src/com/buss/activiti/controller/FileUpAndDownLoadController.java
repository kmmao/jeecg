...
import com.buss.activiti.entity.FileMetaEntity;
/**
 * 
...
//@Scope("prototype")
@Controller
@RequestMapping("/fileUpAndDownLoadController")
public class FileUpAndDownLoadController extends BaseController {
 
	private static final Logger logger = Logger.getLogger(FileUpAndDownLoadController.class);
	...
	public LinkedList<FileMetaEntity> uploadPara(MultipartHttpServletRequest request, HttpServletResponse response) {
		...
		while (itr.hasNext()) {
			...
			try {
				...
				//文件保存路径--相对路径
				fileMetaEntity.setFilePath(userUploadPath + mpf.getOriginalFilename());
