package cn.com.linkwide.ba.bacapiexp.service.impl;
...
@Service("baCapiExpService")
@Transactional
public class BaCapiExpServiceImpl extends CommonServiceImpl implements BaCapiExpServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaCapiExpEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaCapiExpEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaCapiExpEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaCapiExpEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaCapiExpEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_capi_exp",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
