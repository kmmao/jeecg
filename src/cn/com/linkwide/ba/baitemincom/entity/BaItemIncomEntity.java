package cn.com.linkwide.ba.baitemincom.entity;
 ...
 */
@Entity
@Table(name = "ba_item_incom", schema = "")
@SuppressWarnings("serial")
@DetailedEntity(strEntity={"BudgDeptDetailIncomEntity","BudgItemSubEntity","BudgIncomHisEntity"})
public class BaItemIncomEntity implements java.io.Serializable {
	/**主键*/
	...
	/**年度*/
	private java.lang.String budgYear;
	/**项目编码*/
	...
	private java.lang.String budgSource;
	/**项目说明*/
	...
	@Column(name ="BUDG_YEAR",nullable=true,length=32)
	public java.lang.String getBudgYear(){
	 ...
	 */
	public void setBudgYear(java.lang.String budgYear){
	...
	@Column(name ="VNAME",nullable=true,length=255)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  上级项目编码
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  项目说明
	 */

	@Column(name ="ITEM_MEMO",nullable=true,length=32)
	...
	@Column(name ="BUDG_SOURCE",nullable=true,length=32)
	public java.lang.String getBudgSource(){
		return this.budgSource;
	}
	 ...
	 */
	public void setBudgSource(java.lang.String budgSource){
