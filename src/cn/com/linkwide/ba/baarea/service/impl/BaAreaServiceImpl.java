package cn.com.linkwide.ba.baarea.service.impl;
...
@Service("baAreaService")
@Transactional
public class BaAreaServiceImpl extends CommonServiceImpl implements BaAreaServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaAreaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaAreaEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaAreaEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaAreaEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaAreaEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_area",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
