package cn.com.linkwide.ba.baarea.entity;
 ...
 */
@Entity
@Table(name = "ba_area", schema = "")
@SuppressWarnings("serial")
public class BaAreaEntity implements java.io.Serializable {
	/**主键*/
	...
	/**是否直辖市*/
	@Excel(name="是否直辖市",width=15,dicCode="sf_yn")
	private java.lang.String extend2;
	/**是否省级*/
	@Excel(name="是否省级",width=15,dicCode="sf_yn")
	private java.lang.String extend3;
	/**是否市级*/
	@Excel(name="是否市级",width=15,dicCode="sf_yn")
