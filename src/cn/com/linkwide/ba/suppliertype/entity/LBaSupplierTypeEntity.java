package cn.com.linkwide.ba.suppliertype.entity;
 ...
 */
@Entity
@Table(name = "l_ba_supplier_type", schema = "")
@SuppressWarnings("serial")
public class LBaSupplierTypeEntity implements java.io.Serializable {
	/**id*/
	 ...
	 * @return
	 */
	@Column(name ="IS_LAST",nullable=false,length=2)
