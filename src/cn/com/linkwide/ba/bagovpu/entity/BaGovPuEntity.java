package cn.com.linkwide.ba.bagovpu.entity;
 ...
 */
@Entity
@Table(name = "ba_gov_pu", schema = "")
@SuppressWarnings("serial")
@DetailedEntity(strEntity={"BudgGovBuyExpendBEntity"})
public class BaGovPuEntity implements java.io.Serializable {
	/**主键*/
