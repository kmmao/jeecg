package cn.com.linkwide.ba.bagovpu.service.impl;
...
@Service("baGovPuService")
@Transactional
public class BaGovPuServiceImpl extends CommonServiceImpl implements BaGovPuServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaGovPuEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaGovPuEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaGovPuEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaGovPuEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaGovPuEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_gov_pu",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
