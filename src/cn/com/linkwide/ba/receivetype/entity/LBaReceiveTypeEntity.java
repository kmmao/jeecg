package cn.com.linkwide.ba.receivetype.entity;
 ...
 */
@Entity
@Table(name = "l_ba_receive_type", schema = "")
@SuppressWarnings("serial")
public class LBaReceiveTypeEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.Integer isIn;
	...
	@Column(name ="IS_STOP",nullable=true,length=10)
	...
	@Column(name ="IS_IN",nullable=true,length=10)
