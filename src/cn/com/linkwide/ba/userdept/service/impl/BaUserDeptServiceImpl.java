package cn.com.linkwide.ba.userdept.service.impl;
...
@Service("baUserDeptService")
@Transactional
public class BaUserDeptServiceImpl extends CommonServiceImpl implements BaUserDeptServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaUserDeptEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaUserDeptEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaUserDeptEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaUserDeptEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaUserDeptEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_user_dept",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
