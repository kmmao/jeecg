package cn.com.linkwide.ba.userdept.entity;
 ...
 */
@Entity
@Table(name = "ba_user_dept", schema = "")
@SuppressWarnings("serial")
public class BaUserDeptEntity implements java.io.Serializable {
	/**主键*/
