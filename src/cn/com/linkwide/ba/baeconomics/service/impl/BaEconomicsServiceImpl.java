package cn.com.linkwide.ba.baeconomics.service.impl;
...
@Service("baEconomicsService")
@Transactional
public class BaEconomicsServiceImpl extends CommonServiceImpl implements BaEconomicsServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaEconomicsEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaEconomicsEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaEconomicsEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaEconomicsEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaEconomicsEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_economics",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
