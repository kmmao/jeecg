package cn.com.linkwide.ba.material.standtype.entity;
 ...
 */
@Entity
@Table(name = "l_ba_material_stand_type", schema = "")
@SuppressWarnings("serial")
public class LBaMaterialStandTypeEntity implements java.io.Serializable {
	/**id*/
