package cn.com.linkwide.ba.material.standtype.service.impl;
...
@Service("lBaMaterialStandTypeService")
@Transactional
public class LBaMaterialStandTypeServiceImpl extends CommonServiceImpl implements LBaMaterialStandTypeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(LBaMaterialStandTypeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(LBaMaterialStandTypeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(LBaMaterialStandTypeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(LBaMaterialStandTypeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,LBaMaterialStandTypeEntity t){
