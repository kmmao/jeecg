...
public class LBaMaterialEntityVo implements java.io.Serializable {
	/**id*/
	...
	/**是否耗材*/
	@Excel(name="是否采购")
	private java.lang.String isPurc;
	/**是否资产*/
	@Excel(name="是否资产")
	...
	@Column(name ="IS_PURC",nullable=true,length=2)
	public java.lang.String getIsPurc() {
		return isPurc;
	}

	public void setIsPurc(java.lang.String isPurc) {
		this.isPurc = isPurc;
	}
	
	@Column(name ="EXP_UNIT",nullable=true,length=2)
