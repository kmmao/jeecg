package cn.com.linkwide.ba.material.images.service.impl;
...
@Service("lBaMaterialImagesService")
@Transactional
public class LBaMaterialImagesServiceImpl extends CommonServiceImpl implements LBaMaterialImagesServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(LBaMaterialImagesEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(LBaMaterialImagesEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(LBaMaterialImagesEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(LBaMaterialImagesEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,LBaMaterialImagesEntity t){
