package cn.com.linkwide.ba.material.images.entity;
 ...
 */
@Entity
@Table(name = "l_ba_material_images", schema = "")
@SuppressWarnings("serial")
public class LBaMaterialImagesEntity implements java.io.Serializable {
	/**id*/
