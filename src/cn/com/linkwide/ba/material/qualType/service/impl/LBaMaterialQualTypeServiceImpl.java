package cn.com.linkwide.ba.material.qualType.service.impl;
...
@Service("lBaMaterialQualTypeService")
@Transactional
public class LBaMaterialQualTypeServiceImpl extends CommonServiceImpl implements LBaMaterialQualTypeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(LBaMaterialQualTypeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(LBaMaterialQualTypeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(LBaMaterialQualTypeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(LBaMaterialQualTypeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,LBaMaterialQualTypeEntity t){
