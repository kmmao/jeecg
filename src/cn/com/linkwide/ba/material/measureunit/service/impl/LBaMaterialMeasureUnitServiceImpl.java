package cn.com.linkwide.ba.material.measureunit.service.impl;
...
@Service("lBaMaterialMeasureUnitService")
@Transactional
public class LBaMaterialMeasureUnitServiceImpl extends CommonServiceImpl implements LBaMaterialMeasureUnitServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(LBaMaterialMeasureUnitEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(LBaMaterialMeasureUnitEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(LBaMaterialMeasureUnitEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(LBaMaterialMeasureUnitEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("material_id", t.getMaterialId());
		map.put("mater_unit_id", t.getMaterUnitId());
		map.put("conver_rate", t.getConverRate());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,LBaMaterialMeasureUnitEntity t){
 		...
 		sql  = sql.replace("#{conver_rate}",String.valueOf(t.getConverRate()));
