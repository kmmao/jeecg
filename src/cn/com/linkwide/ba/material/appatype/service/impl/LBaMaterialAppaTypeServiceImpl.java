package cn.com.linkwide.ba.material.appatype.service.impl;
...
@Service("lBaMaterialAppaTypeService")
@Transactional
public class LBaMaterialAppaTypeServiceImpl extends CommonServiceImpl implements LBaMaterialAppaTypeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(LBaMaterialAppaTypeEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(LBaMaterialAppaTypeEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(LBaMaterialAppaTypeEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(LBaMaterialAppaTypeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,LBaMaterialAppaTypeEntity t){
