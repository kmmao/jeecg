package cn.com.linkwide.ba.material.appatype.entity;
 ...
 */
@Entity
@Table(name = "l_ba_material_appa_type", schema = "")
@SuppressWarnings("serial")
public class LBaMaterialAppaTypeEntity implements java.io.Serializable {
	/**id*/
