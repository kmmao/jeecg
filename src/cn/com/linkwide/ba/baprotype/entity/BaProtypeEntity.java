package cn.com.linkwide.ba.baprotype.entity;
 ...
 */
@Entity
@Table(name = "ba_protype", schema = "")
@SuppressWarnings("serial")
public class BaProtypeEntity implements java.io.Serializable {
	/**主键*/
	...
	/**外部系统项目分类编码*/
	@Excel(name="外部系统项目分类编码",width=15)
	private java.lang.String voutcode;
	/**外部系统项目分类名称*/
	@Excel(name="外部系统项目分类名称",width=15)
	private java.lang.String voutname;
	/**上级分类*/
	@Excel(name="上级分类",width=15)
	private java.lang.String pkparent;
	/**所属项目大类*/
	@Excel(name="所属项目大类",width=15,dictTable ="ba_itemtype",dicCode ="vitemcode",dicText ="vitemname")
	private java.lang.String pkbaitemtype;
	/**是否末级*/
	@Excel(name="是否末级",width=15,dicCode="sf_yn")
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  项目分类编码
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  项目分类名称
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  外部系统项目分类编码
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  外部系统项目分类编码
	 */
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  外部系统项目分类名称
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  外部系统项目分类名称
	 */
	...
	@Column(name ="PKPARENT",nullable=true,length=32)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  所属项目大类
	 */

	@Column(name ="PKBAITEMTYPE",nullable=true,length=32)
	public java.lang.String getPkbaitemtype(){
		return this.pkbaitemtype;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  所属项目大类
	 */
	public void setPkbaitemtype(java.lang.String pkbaitemtype){
		this.pkbaitemtype = pkbaitemtype;
	}
	/**
	 *方法: 取得java.lang.String
