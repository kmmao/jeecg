package cn.com.linkwide.ba.baitemtype.service.impl;
...
@Service("baItemtypeService")
@Transactional
public class BaItemtypeServiceImpl extends CommonServiceImpl implements BaItemtypeServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaItemtypeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaItemtypeEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaItemtypeEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaItemtypeEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,BaItemtypeEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("ba_itemtype",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
