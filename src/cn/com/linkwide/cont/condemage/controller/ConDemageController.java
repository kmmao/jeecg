 ...
 *
 */
@Api(value="ConDemage",description="合同索赔",tags="conDemageController")
@Controller
@RequestMapping("/conDemageController")
public class ConDemageController extends BaseController {
	/**
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("cn/com/linkwide/cont/condemage/conDemageList");
	}
	...
	public void datagrid(ConDemageEntity conDemage, HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			sql.append(" where 1=1 and b.is_defout='1' and b.con_type='04'  ");
	...
	*/
	...
	public ModelAndView confirmNum(ConDemageEntity conDemage, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/condemage/condemage-suoPei");
	}
	...
	public ModelAndView gochecked(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/condemage/condemage-change");
	}
	...
	public ModelAndView goAdd(ConDemageEntity conDemage, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/condemage/conDemage-add");
	}
	/**
	 * 合同索赔编辑页面跳转
	 * 
