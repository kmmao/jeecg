 ...
 *
 */
@Api(value="ConDemage",description="合同索赔",tags="conDemageReceivController")
@Controller
@RequestMapping("/conDemageReceivController")
public class ConDemageReceivController extends BaseController {
	/**
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("cn/com/linkwide/cont/receivescont/condemage/conDemageList");
	}
	...
	public void datagrid(ConDemageEntity conDemage, HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			sql.append(" where 1=1 and b.is_defout='1' and b.con_type='03'  ");
	...
	*/
	...
	public ModelAndView confirmNum(ConDemageEntity conDemage, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/condemage/condemage-suoPei");
	}
	...
	public ModelAndView gochecked(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/condemage/condemage-change");
	}
	...
	public ModelAndView goAdd(ConDemageEntity conDemage, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/condemage/conDemage-add");
	}
	/**
	 * 合同索赔编辑页面跳转
	 * 
