package cn.com.linkwide.cont.condemage.service.impl;
...
@Service("conDemageService")
@Transactional
public class ConDemageServiceImpl extends CommonServiceImpl implements ConDemageServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ConDemageEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(ConDemageEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(ConDemageEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(ConDemageEntity t){
		...
		map.put("demage_date", t.getDemageDate());
		map.put("fujian", t.getFujian());
		...
		map.put("demage_bz", t.getDemageBz());
		return map;
	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ConDemageEntity t){
 		...
 		sql  = sql.replace("#{demage_date}",String.valueOf(t.getDemageDate()));
 		...
 		sql  = sql.replace("#{demage_bz}",String.valueOf(t.getDemageBz()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("con_demage",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
