 ...
 *
 */
@Api(value="ConInformation",description="收款合同信息",tags="conInformationReceivController")
@Controller
@RequestMapping("/conInformationReceivController")
public class ConInformationReceivController extends BaseController {
	/**
	...
	public ModelAndView list(HttpServletRequest request) {
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformationList");
	}
	 ...
	 * @return
	 */
	@RequestMapping(params = "receiVlist")
	public ModelAndView receiVlist(HttpServletRequest request) {
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformationreceivAssetList");
	}
	...
	public ModelAndView listbg(HttpServletRequest request) {
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/coninformationexchange");
	}
	 ...
	 * 客戶分页参照模糊查询
	 * 
	 * @author wfy 2018-10-12
	 * @param request
	 * @return
	 */
	@RequestMapping(params = "customerList")
	@ResponseBody
	public void customerList(BaCustomerEntity customer,HttpServletRequest request,DataGrid dataGrid, HttpServletResponse response) {
		...
		// 查询条件组装器
		org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, customer);
		try {
			
			// 自定义追加查询条件  
			Disjunction disjunction = Restrictions.disjunction();
			disjunction.add(Restrictions.like("customerCode", q,MatchMode.ANYWHERE).ignoreCase());
			disjunction.add(Restrictions.like("customerFullName", q,MatchMode.ANYWHERE).ignoreCase());
			cq.add(disjunction); 
			//客戶编码不能为空
			Conjunction criteria =  Restrictions.conjunction();
			criteria.add(Restrictions.isNotNull("customerCode"));
			cq.add(criteria); 
			cq.add();
			this.systemService.getDataGridReturn(cq, true); 
			String[]  defArray = defaultVal.split(",");
			if(defArray.length>1 && StringUtil.isNotEmpty(defArray[1]) ){
				BaCustomerEntity d = systemService.findUniqueByProperty(BaCustomerEntity.class, defArray[0], defArray[1]);
				List<BaCustomerEntity> results = dataGrid.getResults();
				if( results ==null) return;
				if(d !=null  ){
					for(BaCustomerEntity dept : results){
						//如果有就结束
	...
	public AjaxJson doBatchDel(String ids,HttpServletRequest request){
		...
		*//**
		...
		public String generateBillCode(){  
			String	billcode="";
		//	String hql=" from ";
			TSFunction function = this.conInformationService.findUniqueByProperty(TSFunction.class, "functionUrl", "conInformationReceivController.do?list");
			if(function==null){
		...
		public ModelAndView confirmNum(ConInformationEntity conInformation, HttpServletRequest req) {
			...
			return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conwyList");
		}
		...
		public ModelAndView confirmbgjl(ConInformationEntity conInformation, HttpServletRequest req) {
			...
			return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformation-alteration");
		}
		...
		public ModelAndView confirmbg11(ConInformationEntity conInformation, HttpServletRequest req) {
			...
			/*	String flag =req.getParameter("flag");
				if("1".equals(flag)){
					conInformation = systemService.findUniqueByProperty(ConInformationEntity.class, "conExec5", conInformation.getConExec5());
				}else{*/
					conInformation = conInformationService.getEntity(ConInformationEntity.class, conInformation.getId());
			...
			return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformation-alteration-examine");
		}
		/**
		 * 合同变更跳转右边页面
		 * 
		...
		public ModelAndView confirmbg22(ConInformationEntity conInformation, HttpServletRequest req) {
			...
			return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformation-alteration-update");
		}
	...
	/*	String uid = UUID.randomUUID().toString();
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformation-add");
	}
	...
	public ModelAndView goUpdate(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformation-update");
	}
	...
	public ModelAndView confirmRenew(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformation/conInformationRenew");
	}
	...
	public ModelAndView conMarkList(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformationdetial/conMarkList");
	}
	/**
	 * 加载明细列表[合同付款计划]
	 * 
	...
	public ModelAndView payPlanList(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformationdetial/payPlanList");
	}
	/**
	 * 加载明细列表[合同付款大事记]
	 * 
	...
	public ModelAndView conMemorabiliaList(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformationdetial/conMemorabiliaList");
	}
	/**
	 * 加载明细列表[银行保函]
	 * 
	...
	public ModelAndView contBankList(ConInformationEntity conInformation, HttpServletRequest req) {
		...
		return new ModelAndView("cn/com/linkwide/cont/receivescont/coninformationdetial/contBankList");
	}
