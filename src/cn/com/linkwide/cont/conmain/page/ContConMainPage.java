...
package cn.com.linkwide.cont.conmain.page;
 ...
 * @date 2018-06-05 14:44:27
 * @version V1.0   
 *
 */
public class ContConMainPage implements java.io.Serializable {
	/**主键*/
	...
	/**保存-合同明细*/
    @ExcelCollection(name="合同明细")
	private List<ContConDetailEntity> contConDetailList = new ArrayList<ContConDetailEntity>();
		public List<ContConDetailEntity> getContConDetailList() {
		return contConDetailList;
		}
		public void setContConDetailList(List<ContConDetailEntity> contConDetailList) {
		this.contConDetailList = contConDetailList;
		}
}
