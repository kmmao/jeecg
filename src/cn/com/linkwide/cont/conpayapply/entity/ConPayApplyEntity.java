package cn.com.linkwide.cont.conpayapply.entity;
 ...
 */
@Entity
@Table(name = "con_pay_apply", schema = "")
@SuppressWarnings("serial")
public class ConPayApplyEntity implements java.io.Serializable {
	/**主键*/
	...
	private java.lang.String isDesend;
	/**申请金额*/
    @Excel(name="提交人员",width=15)
	private java.lang.String desendEmp;
    @Excel(name="提交日期",width=15,format = "yyyy-MM-dd")
 	private java.util.Date desendDate;
    
    
    
    
	@Column(name ="IS_DESEND",nullable=true,length=50)
	public java.lang.String getIsDesend() {
		return isDesend;
	}

	public void setIsDesend(java.lang.String isDesend) {
		this.isDesend = isDesend;
	}
	@Column(name ="DESEND_EMP",nullable=true,length=50)
	public java.lang.String getDesendEmp() {
		return desendEmp;
	}

	public void setDesendEmp(java.lang.String desendEmp) {
		this.desendEmp = desendEmp;
	}
	@Column(name ="DESEND_DATE",nullable=true,length=50)
	public java.util.Date getDesendDate() {
		return desendDate;
	}

	public void setDesendDate(java.util.Date desendDate) {
	...
	@Column(name ="CON_NO",nullable=true,length=50)
	...
	@Column(name ="OTHER_COMPY",nullable=true,length=32)
