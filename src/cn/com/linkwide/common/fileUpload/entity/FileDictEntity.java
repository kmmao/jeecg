package cn.com.linkwide.common.fileUpload.entity;
 ...
 */
@Entity
@Table(name = "file_dict", schema = "")
@SuppressWarnings("serial")
public class FileDictEntity implements java.io.Serializable {
	/**主键*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  主键值
	 */

	@Column(name ="TABLE_ID",nullable=true,length=36)
