package cn.com.linkwide.common.fileUpload.service.impl;
...
@Service("fileDictService")
@Transactional
public class FileDictServiceImpl extends CommonServiceImpl implements FileDictServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(FileDictEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(FileDictEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(FileDictEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(FileDictEntity t){
		...
		map.put("file_type", t.getFileType());
		map.put("table_name", t.getTableName());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,FileDictEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("vendor_file_dict",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
