package cn.com.linkwide.common.pubsetting.codeptcl.service.impl;
...
@Service("coDeptclService")
@Transactional
public class CoDeptclServiceImpl extends CommonServiceImpl implements CoDeptclServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(CoDeptclEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(CoDeptclEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(CoDeptclEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(CoDeptclEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,CoDeptclEntity t){
