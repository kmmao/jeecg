...
//				FileCopyUtils.copy(mf.getBytes(), savefile);
	...
	@Override
	public void findPageForHql(String hql, DataGrid dataGrid, List param, String countHql) {
			List<Map<String,Object>> list  = new ArrayList<Map<String,Object>>();  
			try { 	  
					 if(dataGrid.getSort() != null ){
						  hql += " order by "+dataGrid.getSort()+" "+dataGrid.getOrder();
					  }
					  //匹配参数
					  ...
					  list =  q.setFirstResult((dataGrid.getPage()-1)*dataGrid.getRows()).setMaxResults(dataGrid.getRows()).list();
				      //设置结果集
