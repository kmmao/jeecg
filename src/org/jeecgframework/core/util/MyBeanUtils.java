...
//              }
   ...
   * @return
   */
  public static String getPropertyColum(Class T,String property){
	  String name = "";
		Annotation[] deAnnos;
		try {
			deAnnos = T.getMethod("get"+toUpperCaseFirstOne(property)).getDeclaredAnnotations();
			for(Annotation a :deAnnos){
				if(a.annotationType().isAssignableFrom(javax.persistence.Column.class)){
					name = ((javax.persistence.Column)a).name();
				}
			}
   ...
   * @return
   */
  public static String getPropertyColum(String entityName,String property){
	  String name = "";
		Annotation[] deAnnos;
		try {
			deAnnos = Class.forName(entityName).getMethod("get"+toUpperCaseFirstOne(property)).getDeclaredAnnotations();
			for(Annotation a :deAnnos){
				if(a.annotationType().isAssignableFrom(javax.persistence.Column.class)){
					name = ((javax.persistence.Column)a).name();
				}
