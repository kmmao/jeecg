...
width:200px!important;
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSCompanyController.do?doUpdate"  callback="@Override doback">
					<input id="id" name="id" type="hidden" value="${tSCompanyPage.id }"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		<caption>单位修改</caption>
				<tr>
					<td align="right">
					...
					<td class="value">
					     	 <input id="companyCode" name="companyCode" type="text" maxlength="50" style="width: 150px;" class="inputxt" readonly="readonly" datatype="*"  onchange="setAdm()" ignore="checked" validType="t_s_company,company_code,id"  value="${tSCompanyPage.companyCode }" />
					...
					<td class="value">
					     	 <input id="administrator" name="administrator" type="text" maxlength="32" style="width: 150px" class="inputxt"  readonly="readonly" ignore="ignore"  validType="t_s_company,company_name,id"  value="${tSCompanyPage.administrator }" />
							<span class="Validform_checktip"></span>
				...
				<td align="right">
					...
					<td class="value">
					     	<t:dictSelect field="parentId" type="list"  dictTable="t_s_company" dictField="id" dictText="company_name"  dictCondition=" where parent_id != '${tSCompanyPage.id }' or  parent_id is null  "   
		     	    		defaultVal="${tSCompanyPage.parentId}" hasLabel="false"  title="业务类型" ></t:dictSelect>  
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="province" name="province" type="text" maxlength="32" style="width: 150px" class="inputxt" ignore="ignore"  value="${tSCompanyPage.province }" />
							<span class="Validform_checktip"></span>
