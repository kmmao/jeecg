...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lBaMaterialImagesController.do?doUpdate" tiptype="1" >
					<input id="id" name="id" type="hidden" value="${lBaMaterialImagesPage.id }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
				<td align="right">
					<label class="Validform_label"> 图片:
					</label>
				</td>
				<td class="value">
						<input id="filePath" name="filePath" type="hidden" value=${lBaMaterialImagesPage.filePath }>
						<input id="fileName" name="fileName" type="text" style="width: 190px;height: 25px;" class="inputxt"  readonly="readonly" value='${lBaMaterialImagesPage.fileName }' datatype="*1-36"/>
 ...
 <script src = "webpage/cn/com/linkwide/ba/material/images/lBaMaterialImages.js"></script>	
