...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lBaMaterialImagesController.do?doAdd" tiptype="1" >
					<input id="id" name="id" type="hidden" value="${lBaMaterialImagesPage.id }">
					<input id="materialId" name="materialId" type="hidden"  value="${lBaMaterialId }">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value">
						...
						<input id="fileName" name="fileName" type="text" style="width: 190px;height: 25px;" class="inputxt"  readonly="readonly" datatype="*1-36" />
