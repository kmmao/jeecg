...
<html>
  ...
  //编写自定义JS代码
	...
	<body>
		...
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"	action="lBaMaterialTypeController.do?doAdd" tiptype="1" callback="@Override noteSubmitCallback">
				...
				<tr>
					...
					<td class="value">
						<input id="parentId" name="parentId" type="hidden"
							...
							value='${lBaMaterialTypePage.parentId}'>
