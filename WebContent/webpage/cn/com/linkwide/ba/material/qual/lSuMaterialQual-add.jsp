...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="lSuMaterialQualController.do?doAdd" beforeSubmit="subVali()">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="billNo" name="billNo" type="text" style="width: 150px" class="inputxt" readonly="readonly" disabled="disabled">
			...
			<td class="value">
					  <input id="billDate" name="billDate" type="text" style="width: 150px"  value="<fmt:formatDate value='<%=new Date() %>' type='date' pattern='yyyy-MM-dd'/>"
		...
		<tr>
			...
			<td class="value" colspan="3">
		     	 <!-- <input id="materialId" name="materialId" type="text" style="width: 150px" class="inputxt"datatype="*"> -->
		     	 <t:materialSelect lblName="物资" selectedIdsInputId="materialId" materialNameInputWidth="150px" selectedNamesInputId="materialn" title="物资"  hasNull="true"></t:materialSelect>
				<span class="Validform_checktip"></span>
