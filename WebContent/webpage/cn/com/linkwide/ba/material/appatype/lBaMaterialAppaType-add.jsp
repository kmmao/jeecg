...
function noteSubmitCallback(data) {
	...
	<body>
		...
		<t:formvalid formid="formobj" dialog="true" usePlugin="password"
			layout="table" 
			action="lBaMaterialAppaTypeController.do?doAdd" tiptype="1" callback="@Override noteSubmitCallback">
			<input id="id" name="id" type="hidden"
				value="${lBaMaterialAppaTypePage.id }">
				...
				<tr>
					...
					<td class="value">
						<input id="parentId" name="parentId" type="hidden"
							...
							value='${lBaMaterialAppaTypePage.parentId}'>
