...
<div class="easyui-layout" style="width:100%; height: 100%;">
    ...
    <div data-options="region:'west',split:true" title="" style="width: 180px;">
		<ul id="materialAppaTypeSelect" class="ztree" style="margin-top: 10px;"></ul>
	</div>
 ...
 <script src = "webpage/cn/com/linkwide/ba/material/appatype/lBaMaterialAppaType.js"></script>		
