...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lBaMaterialController.do?doAdd" tiptype="1"  beforeSubmit="vl()">
		...
		<table cellpadding="0" cellspacing="1" class="formtable" >
				<tr>
					...
					<td class="value">
					 <t:comboList name="materialName" url="lBaMaterialController.do?incl"  id="materialName" idField="id" textField="invName"   datatype="*" ignore="checked" field="invName,specModel,price,supplierFullName,supplierId,id"   onSelect="setvalue" panelWidth="500" title="物资名称:80,规格型号:80,单价:70,供应商:80," ></t:comboList>
