...
<div data-options="region:'west',
  ...
  <t:datagrid name="lBaMaterialList" checkbox="true" autoLoadData="false" fitColumns="false" title="" actionUrl="lBaMaterialController.do?datagridAllMain" idField="id" fit="true" queryMode="group">
  ...
  <%--  <t:dgToolBar title="添加" icon="icon-add" url="lBaMaterialController.do?goAdd" funname="addFun" width="1000" height="500"></t:dgToolBar> --%>
    <t:dgToolBar title="中标物资维护" icon="icon-add" url="lBaMaterialController.do?goAddMain" funname="addFun" width="1000" height="500"></t:dgToolBar>
