...
<div data-options="region:'west',
  ...
  <t:datagrid name="lBaMaterialList4Select" checkbox="true" autoLoadData="false" fitColumns="false" title="" actionUrl="lBaMaterialController.do?datagrid&wid=${wid}&sid=${sid}&isHighCons=${isHighCons}" idField="id" fit="true" queryMode="group">
