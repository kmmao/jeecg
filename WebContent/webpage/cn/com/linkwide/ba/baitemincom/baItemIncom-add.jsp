...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="baItemIncomController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="vcode" name="vcode" type="text" validType="ba_item_incom,vcode,id" style="width: 150px" class="inputxt"  datatype="*" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
				...
				<tr>
					...
					<td class="value">
							<t:dictSelect field="budgSource" type="list" datatype="*" typeGroupCode="bd_csource"  defaultVal="非财政收入" hasLabel="false"  title="资金来源" ></t:dictSelect>
							<span class="Validform_checktip"></span>
