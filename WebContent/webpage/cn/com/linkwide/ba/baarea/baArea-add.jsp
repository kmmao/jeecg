...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="3" action="baAreaController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="areaCode" name="areaCode" validType="ba_area,area_code,id" type="text" style="width: 150px" class="inputxt"  datatype="*" />
				...
				<tr>
					...
					<td class="value">
					     	 <input id="areaName" name="areaName" type="text" style="width: 150px" class="inputxt"  datatype="*" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="extend1" name="extend1" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					<input id="parentCode" name="parentCode" type="text" style="width: 150px" class="inputxt"  ignore="ignore"/>
						<%-- <input id="parentCode" name="parentCode" type="text" style="width: 150px" class="inputxt easyui-combotree"  ignore="ignore" 
							data-options="panelHeight:'220',
				                    url: 'baAreaController.do?datagrid&field=id,areaCode,areaName',  
				...
				<tr>
					...
					<td class="value">
							  <t:dictSelect field="isLast" type="list" datatype="*" typeGroupCode="sf_yn"  defaultVal="${baAreaPage.isLast}" hasLabel="false"  title="是否末级" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
