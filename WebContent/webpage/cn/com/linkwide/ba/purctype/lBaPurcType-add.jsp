...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lBaPurcTypeController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="code" name="code" type="text" style="width: 150px" class="inputxt"  validType="l_ba_purc_type,code,id" datatype="*" onblur="check(this)"  ignore="checked" />
				...
				<tr>
					...
					<td class="value">
					     	 <t:dictSelect field="inType" type="list"  dictTable="l_ba_receive_type" dictField="id" dictText="name" datatype="n"  defaultVal="${lBaPurcTypePage.inType}" hasLabel="false"  title="收发类型" ></t:dictSelect>     
							 <span class="Validform_checktip"></span>
