...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="lBaDepartMatetypeController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							 ...
							 <t:comboTree id="matetypeId" name="matetypeId" url="lBaMaterialTypeController.do?comboTreeType" value="${lBaDepartMatetypePage.matetypeId}"	width="155" multiple="false" ></t:comboTree>
							<span class="Validform_checktip"></span>
