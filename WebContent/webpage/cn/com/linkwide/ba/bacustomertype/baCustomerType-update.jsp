 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="typeCode" name="typeCode" type="text" style="width: 150px" class="inputxt"  datatype="*1-36" value='${baCustomerTypePage.typeCode}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="typeName" name="typeName" type="text" style="width: 150px" class="inputxt"  datatype="*1-36"  value='${baCustomerTypePage.typeName}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<t:dictSelect field="extend1" type="list" hasShowCheck="false" hasLabel="false" typeGroupCode="whether" defaultVal="${baCustomerTypePage.extend1}" title="是否末级" ></t:dictSelect>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<t:dictSelect field="status" type="list" hasShowCheck="false" hasLabel="false" typeGroupCode="whether" defaultVal="${baCustomerTypePage.status}" title="是否停用" ></t:dictSelect>
