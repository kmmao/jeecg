...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="baBankrollSourceController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="code" name="code" type="text" style="width: 150px" class="inputxt" 		validType="ba_bankroll_source,code,id" datatype="*" ignore="checked"  value='${baBankrollSourcePage.code}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  ignore="checked"  value='${baBankrollSourcePage.name}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							 <t:dictSelect field="iflater" type="list" datatype="*"  typeGroupCode="sf_yn" 
							  	defaultVal="${baBankrollSourcePage.iflater}" hasLabel="false"  title="支出类型"></t:dictSelect>
