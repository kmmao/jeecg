...
<%-- <div id="tempSearch" style="display: none">
		<div id="tempColums">
			...
			<t:comboTree id="supplierTypeId" name="supplierTypeId" url="lBaSupplierTypeController/getTreeAllDateForstate" />
		</div></div> --%>
...
<div data-options="region:'west',
  ...
  <t:datagrid name="supplier4select" checkbox="false" autoLoadData="false" fitColumns="false" title="供应商" actionUrl="lBaSupplierController.do?datagridAll&mid=${mid }" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="供应商类型"  field="supplierTypeId"  dictionary="l_ba_supplier_type,id,type_name" queryMode="group" width="120"></t:dgCol>
 		...
 		//给时间控件加上样式
 			...
 			$('#supplier4select_Type').tree({
				...
				onLoadSuccess:function(node,data){
					...
					if(n){
						$('#supplier4select').datagrid('options').url = 'lBaSupplierController.do?datagridAll&mid=${mid }&field=id,supplierCode,supplierFullName,supplierShortName,supplierTypeId,contacts,telphone,address,isControl';
