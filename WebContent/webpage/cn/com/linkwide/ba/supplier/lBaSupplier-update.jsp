 ...
 <body>
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="supplierCode" name="supplierCode" type="text" style="width: 150px" class="inputxt" datatype="*1-36" value='${lBaSupplierPage.supplierCode}'>
						...
						<td class="value">
						     	 <input id="supplierFullName" name="supplierFullName" type="text" style="width: 150px" class="inputxt" datatype="*1-36" value='${lBaSupplierPage.supplierFullName}'>
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							...
							<t:comboList id="affiliatedArea"  name="affiliatedArea"  url="dictListController.do?areaList" idField="areaCode" value="${lBaSupplierPage.affiliatedArea}" textField="areaName" ignore="ignore"
				...
				<tr>
					...
					<td class="value">
					     	 <input id="registerCapital" name="registerCapital" type="text" value='${lBaSupplierPage.registerCapital}' onblur="checkmoney(this)" style="width: 150px" class="inputxt"  >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							<t:dictSelect field="supplierSource" type="list" defaultVal="${lBaSupplierPage.supplierSource}" hasShowCheck="false" readonly = "readonly" hasLabel="false" typeGroupCode="slm_source"  title="供应商来源"></t:dictSelect>
