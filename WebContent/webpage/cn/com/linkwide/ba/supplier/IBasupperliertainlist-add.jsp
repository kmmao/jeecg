...
//显示树下拉
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true"  layout="table" action="lBaSupplierController.do?doUpdate" tiptype="1" beforeSubmit="check_sub()">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <t:comboList name="supplierFullName" url="lBaSupplierTypeController.do?suppliername"  id="supplierfullname" idField="supplierfullname" textField="supplierfullname"   datatype="*" ignore="checked" field="supplierfullname,uscc,contacts,telphone,vendor"  value='${supplierTypeId }' onSelect="setvalue" panelWidth="700" title="供应商名称:80,社会统一信用码:80,联系人:70,供应商电话:80" ></t:comboList>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="uscc" name="uscc" type="text" style="width: 150px" class="inputxt" datatype="*" validType="l_ba_supplier,uscc,id" ignore="checked"  >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="registerCapital" name="registerCapital" type="text" style="width: 150px" class="inputxt"  >
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<t:dictSelect field="isLogin" type="list" hasShowCheck="false" hasLabel="false" typeGroupCode="whether" defaultVal="1" title="是否允许登录供应商平台"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							<t:dictSelect field="isQualified" type="list" hasShowCheck="false" hasLabel="false" typeGroupCode="whether" defaultVal="1" title="是否合格供应商"></t:dictSelect>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/cn/com/linkwide/ba/supplier/lBaSupplier.js">
