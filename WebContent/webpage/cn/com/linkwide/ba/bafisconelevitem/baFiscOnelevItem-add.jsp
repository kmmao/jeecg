...
// 		        		return false;
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="baFiscOnelevItemController.do?doAdd" tiptype="3">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="vcode" name="vcode" type="text" style="width: 150px" validType="ba_item_incom,vcode,id" class="inputxt"  datatype="*" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
				...
				<tr>
					...
					<td class="value">
<!-- 						<input id="budgYear" name="budgYear" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" /> -->
						<input id="budgYear" name="budgYear" type="text"  class="easyui-combobox"  panelHeight="auto" 
					...
					<td class="value">
						<input id="parentCode" name="parentCode" type="text" style="width: 150px" class="inputxt easyui-combotree"  ignore="ignore" />
							...
							data-options="panelHeight:'220',
				                    url: 'baFiscOnelevItemController.do?datagrid&field=id,vcode,vname,budgYear',  
				...
				<tr>
					...
					<td class="value">
					     	<t:dictSelect field="isStop" type="select"  datatype="*" defaultVal="N" typeGroupCode="sf_yn"  hasLabel="false"  title="是否停用"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="itemMemo" name="itemMemo" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
