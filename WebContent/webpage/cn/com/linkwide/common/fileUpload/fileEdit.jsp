...
<script type="text/javascript">
 ...
 var stringId ="";
  ...
  function editObj(id) {
  	gridname=name;
  	/* debugger;
  	if(document.getElementById('WebOffice').Titlebar == null) { 
   ...
   <tbody>
    <tr height="60px">
     ...
     <td class="value" width="140px">
      <t:upload name="instruction" dialog="false" fileSizeLimit="100MB" multi="false" extend="" queueID="instructionfile" view="false" auto="true" uploader="cgUploadController.do?ajaxSaveFile&modName=${modName}&tableName=${tableName}&tableId=${tableId}" onUploadSuccess="uploadSuccess"  id="instruction" formData="documentTitle"></t:upload>
     </td>
	...
	<c:if test="${fn:length(fileDictList)  > 0 }">
		<c:forEach items="${fileDictList}" var="poVal" varStatus="stuts">
			<tr id="fileDictList${stuts.index}" datagrid-row-index="0" class="datagrid-row datagrid-row-selected datagrid-row-over" style="height: 51px;">
				...
				<td field="filePath"><div style="height:auto;" class="datagrid-cell datagrid-cell-c1-filePath"><img width="30" class="img" height="30" border="0" onmouseover="tipImg(this)" onmouseout="moveTipImg()" src="${realPath}${poVal.filePath }"></div></td>
