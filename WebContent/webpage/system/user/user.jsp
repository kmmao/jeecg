...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			<td align="right"><label class="Validform_label"> <t:mutiLang langKey="common.syscompany"/>: </label></td>
			<td class="value">
                <t:dictSelect field="sysCompanyCode" type="list"  dictTable="t_s_company" dictField="company_code"   dictText="company_name"   datatype="*"    
		     	    		defaultVal="${user.sysCompanyCode}" hasLabel="false"  title="单位"  readonly="readonly" ></t:dictSelect>  
                <span class="Validform_checktip"><t:mutiLang langKey="please.must.syscompany"/></span>
            </td>
		</tr>
		<tr>
