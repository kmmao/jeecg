 ...
 <head>
  ...
  <script type="text/javascript">
   ...
   function executionOfBusiness(item){
	   ...
	   //字段的值
	   //paraValue = $("input[name='"+param+"']").val();
   ...
   $(document).ready(function(){
	  // $("#busiDiv").load("${controller_name}.do?goUpdate&id=${busiID}&homeIn=home",
	   $("#busiDiv").load("${controller_name}.do?goUpdate&isActiviti=Y&id=${busiID}",function(){
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						<c:forEach items="${commentList}" varStatus="" var="item">
						 ...
						 <tr>
							...
							<td class="value">
						  		<textarea style="width:450px;" class="inputxt" rows="3" id="comment" maxlength="200"  name="comment"></textarea>
						...
						<tr>
							<td colspan="4" align="center" height="30px" width='600px'>				 	
