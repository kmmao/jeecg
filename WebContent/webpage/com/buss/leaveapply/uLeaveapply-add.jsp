...
<html>
 ...
 <body>
  <t:formvalid formid="formSubmit" dialog="true" usePlugin="password" layout="table" action="uLeaveapplyController.do?doAdd" tiptype="1" >
...
>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="days" name="days" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
